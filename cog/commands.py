...
class Comandos(
    ...
    async def eightball(self, ctx, *, args):
        ...
        if args is not None:
            ...
            embed.add_field(name='A tu pregunta de...', value=f'*"{args}"*',
                            inline=False)
            embed.add_field(name='La respuesta es:', value=eightball_answer,
                            inline=False)
    ...
    async def probability(self, ctx, *, args):
        ...
        if args is not None:
            ...
            embed = discord.Embed(colour=discord.Color.blue(),
                                  timestamp=datetime.datetime.utcnow())
            embed.add_field(name='La probabilidad de...', value=f'*"{args}"*',
                            inline=False)
            embed.add_field(name='Es de un:', value=f'**{probabilidad}%**',
                            inline=False)
            embed.set_footer(text=ctx.guild, icon_url=ctx.guild.icon_url)
            await ctx.send(embed=embed)
